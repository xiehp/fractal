...
public class Domains extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> CHECK_CONSTRAINT = createField(DSL.name("CHECK_CONSTRAINT"), SQLDataType.VARCHAR(1000000000), this, "");
     ...
     */
    public final TableField<Record, String> SQL = createField(DSL.name("SQL"), SQLDataType.VARCHAR(1000000000), this, "");
